...
const WORD_BANK: WordEntry[] = [
  ...
  { word: 'abundant', tier: 'easy', gloss: 'existing in large amounts; plentiful',
    ...
    ant: { answer: 'scarce', d: [d('ample', ANT_SYNONYM), d('costly', ANT_SAME_TOPIC), d('limited', ANT_NEAR_MISS)] } },
  ...
  { word: 'honest', tier: 'easy', gloss: 'truthful and sincere',
    ...
    ant: { answer: 'deceitful', d: [d('sincere', ANT_SYNONYM), d('rude', ANT_SAME_TOPIC), d('sneaky', ANT_NEAR_MISS)] } },
  ...
  { word: 'bold', tier: 'easy', gloss: 'willing to take risks; confident and daring',
    ...
    ant: { answer: 'timid', d: [d('fearless', ANT_SYNONYM), d('rude', ANT_SAME_TOPIC), d('shy', ANT_NEAR_MISS)] } },
  ...
  { word: 'reveal', tier: 'easy', gloss: 'to make something known; to show',
    ...
    ant: { answer: 'conceal', d: [d('expose', ANT_SYNONYM), d('display', ANT_SAME_TOPIC), d('cover', ANT_NEAR_MISS)] } },
  ...
  { word: 'hostile', tier: 'medium', gloss: 'unfriendly and aggressive',
    ...
    ant: { answer: 'friendly', d: [d('aggressive', ANT_SYNONYM), d('rude', ANT_SAME_TOPIC), d('welcoming', ANT_NEAR_MISS)] } },
